  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: '#080808' }}>
      ...
      <div className="relative z-10 flex items-center justify-between px-6 pt-12 pb-6">
        ...
        <Link to="/login" className="text-xs font-bold" style={{ color: '#CCFF00' }}>SIGN IN</Link>
      </div>
      ...
      <div className="relative z-10 flex-1 px-6 pb-10">
        ...
        {/* Title */}
        <div className="mb-8">
          <div className="label-upper mb-2" style={{ color: '#CCFF00' }}>New Operative</div>
          <h1 className="text-4xl font-black uppercase text-white leading-tight">
            JOIN THE<br />
            <span style={{ color: '#CCFF00' }}>SECTOR.</span>
          </h1>
          <p className="text-sm mt-2" style={{ color: '#666' }}>
            Create your profile and start capturing territory.
          </p>
        </div>
        ...
        <div className="card mb-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Username */}
            <div>
              <label className="label-upper mb-2 block">Operative Name</label>
              <input
                type="text"
                name="username"
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-xs" style={{ color: '#444' }}>SECURE AUTH</span>
          <div className="flex-1 h-px" style={{ background: '#222' }}/>
        </div>
